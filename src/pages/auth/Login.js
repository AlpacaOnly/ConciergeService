...
export function Login() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 h-screen w-fill lg:overflow-hidden">
      ...
      <div className="bg-gray-800 flex flex-col justify-center">
        <form className="max-w-[400px] w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg" onSubmit={(e) => e.preventDefault()}>
